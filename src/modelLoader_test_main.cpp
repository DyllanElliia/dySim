...
auto cornell_box2() {
  ...
  Real begin = 0.35, end = 0.65;
  objects.add(
      std::make_shared<dym::rt::xz_rect<true>>(0, end, 0, begin, 1, white));
  objects.add(
      std::make_shared<dym::rt::xz_rect<true>>(end, 1, 0, end, 1, white));
  objects.add(
      std::make_shared<dym::rt::xz_rect<true>>(begin, 1, end, 1, 1, white));
  objects.add(
      std::make_shared<dym::rt::xz_rect<true>>(0, begin, begin, 1, 1, white));
  objects.add(std::make_shared<dym::rt::xz_rect<true>>(begin, end, begin, end,
                                                       0.998, light));
